               ...
               {documents &&
                  documents.map((document, idx) => {
                     return (
                        <Link
                           key={document.id}
                           className={`group flex py-5 pl-4 pr-6 items-center justify-between ${
                              idx % 2 === 0 ? 'bg-raisin-black-light' : null
                           } hover:bg-raisin-black-lighter rounded-md transition duration-200`}
                           href={document.documentDisplayLink}
                        >
                           <div className="flex max-w-5xl pr-10">
                              ...
                              <div>
                                 ...
                                 <span className="text-md mt-1 block  text-yinmn-blue-200 font-medium">
                                    {document.belongsTo?.name}
                                 </span>
                                 <span className="text-sm inline-block mt-2   text-cool-gray-500 font-medium">
                                    {document.description
                                       ? document.description
                                       : 'O documento não possui descrição'}
                                 </span>
                              </div>
                           </div>
