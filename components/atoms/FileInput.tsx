...
function FileInput({ state, setState }: FileInputProps) {
   return (
      <div className="flex flex-wrap items-start -mx-4 pb-8 mb-8 border-b border-cool-gray-900 border-opacity-10">
         <div className="w-full sm:w-1/3 px-4 mb-6 sm:mb-0">
            <span className="block text-md font-medium text-cool-gray-500">
               Arquivo
            </span>
         </div>
         <div className="w-full sm:w-2/3 px-4">
            <div className="flex flex-wrap sm:flex-nowrap max-w-xl">
               <div className="w-full py-8 px-4 text-center border-dashed border text-cool-gray-200 placeholder-cool-gray-200 font-medium outline-none bg-transparent border-raisin-black-lighter hover:border-cool-gray-900 focus-within:border-carolina-blue rounded-lg">
                  <div className="relative group h-14 w-14 mx-auto mb-4">
                     <div className="flex items-center justify-center h-14 w-14 bg-yinmn-blue-900 group-hover:bg-yinmn-blue-500 rounded-full">
                        <svg
                           className="fill-cool-gray-900 hover:fill-cool-gray-200"
                           width="20"
                           height="20"
                           viewBox="0 0 20 20"
                           fill="none"
                  ...
                  <p className="font-semibold leading-normal mb-1">
                     <span className="text-yinmn-blue-900">
                        Selecione o arquivo desejado
                     </span>
                     <span className="text-cool-gray-900">
                        {' '}
