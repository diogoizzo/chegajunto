...
export default function Menu({ children }: any) {
   ...
   return (
      <>
         <Toaster />
         <nav className="lg:hidden flex items-center justify-between z-50   bg-raisin-black shadow-mh shadow-black">
            <div className="w-full xl:w-auto  xl:mr-12 h-20">
               <div className="flex items-center px-8 pt-5  justify-between">
                  <Link
                     passHref
                     className="inline-flex items-center h-8 dashboardMobile"
                     href="#"
                  ></Link>
                  <div className="lg:hidden flex w-full  flex-row justify-between items-center overflow-visible">
                     <Link passHref className="inline-block" href="/">
                        <img
                           className="h-7 "
                     ...
                     >
                        <svg
                           className="text-cool-gray-200 w-7 h-7"
                           xmlns="http://www.w3.org/2000/svg"
                           viewBox="0 0 24 24"
                           id="times"
                        >
               ...
               <nav
                  className={`${
                     isOpen ? 'block' : 'hidden'
                  } relative w-full shadow-md shadow-raisin-black z-40`}
               >
                  <ul className="w-full text-center pt-3  bg-raisin-black text-cool-gray-200 ">
                     <Link
                        passHref
                        className="inline-block w-full h-full"
                        href="/compromissos"
                     >
                        <li className=" space-x-3 relative border-y border-raisin-black-light inline-flex items-center justify-center w-full py-5 ">
                           <svg
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 24 24"
                              fill="currentColor"
                     ...
                     <Link
                        ...
                        href="/pacientes"
                     >
                        <li className=" space-x-3 relative border-b border-raisin-black-light inline-flex items-center justify-center w-full py-5 ">
                           <svg
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 24 24"
                              fill="currentColor"
                     ...
                     <button onClick={() => signOut()} className="w-full">
                        <li className=" space-x-3 relative  inline-flex items-center justify-center w-full py-5 ">
                           <svg
                              width="20"
                              height="20"
                              viewBox="0 0 20 20"
            ...
            <nav className="fixed top-0 left-0 bottom-0 max-w-max flex flex-col h-full py-6 px-4 bg-raisin-black ">
               ...
               <div className="mb-6">
                  <ul>
                     ...
                     {
                        //@ts-ignore
                        session && session.type === 'Psicólogo' ? (
                           <li>
                              <Link
                                 passHref
         ...
         <main className="mx-auto relative  bg-raisin-black-light min-h-[100vh]  w-full">
